...
export const PasswordRecoveryView = () => {
    ...
    const handleSubmit = () => {
        setLoading(true)
        alert.hide()
        post_recover_password(password, passwordConfirmation)
            .then(navigate(Route.reset_password_complete()))
    }
        ...
        <>
            ...
            <CenterSplitLayout>
                <FieldSet>
                    ...
                    <TextInputField label='password confirmation' onUpdate={setPasswordConfirmation} />
                </FieldSet>
                <FieldSet>
